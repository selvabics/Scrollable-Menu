...
- (void)commonInit
{
    ...
    _indicatorAttributes = @{CMTabIndicatorColor:CMHEXCOLOR(0x000000),CMTabIndicatorViewHeight:@(2.0f),CMTabBoxBackgroundColor:CMHEXCOLOR(0x000000)};
    _normalAttributes = @{NSFontAttributeName:[UIFont boldSystemFontOfSize:12.0f],NSForegroundColorAttributeName:CMHEXCOLOR(0x8F9CB3)};
    _selectedAttributes = @{NSFontAttributeName:[UIFont boldSystemFontOfSize:12.0f],NSForegroundColorAttributeName:CMHEXCOLOR(0x000000)};
...
- (void)contentOffSet:(CGFloat)tabbarOffsetX {
    [self setTabbarOffsetX:tabbarOffsetX];
}
